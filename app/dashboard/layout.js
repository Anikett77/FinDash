...
export default function DashboardLayout({ children }) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* ── Sidebar ── */}
      <aside className="w-64 flex-shrink-0 fixed top-0 left-0 h-screen flex flex-col bg-white border-r border-gray-200 z-40">
        ...
        <div className='border-b border-gray-500/40 w-5/6 ml-6 my-5'></div>
