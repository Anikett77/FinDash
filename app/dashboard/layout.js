...
const NAV_ITEMS = [
  ...
  {
    id: 'records', label: 'Records', href: '/dashboard/records',
  ...
  },
  {
    ...
    icon: <svg width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.75" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z"/></svg>
  },
  {
  ...
  return (
    <>
      <div className="px-6 py-5 border-b border-gray-100">
        <div className="flex items-center gap-2.5 ml-3 mt-3">
      ...
      <div className="border-b border-gray-500/40 w-5/6 ml-6 my-5" />
...
export default function DashboardLayout({ children }) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* ── Desktop sidebar — exactly as you had it, just hidden on mobile ── */}
      <aside className="w-64 flex-shrink-0 fixed top-0 left-0 h-screen flex-col bg-white border-r border-gray-200 z-40 hidden md:flex">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 flex items-center justify-between px-4 h-14">
        <span className="text-lg font-bold text-blue-950">FinDash</span>
      ...
      {mobileOpen && (
        <>
          ...
          <aside className="md:hidden fixed top-0 left-0 h-screen w-72 flex flex-col bg-white border-r border-gray-200 z-50"
      ...
      {/* ── Page content — unchanged on desktop ── */}
      <div className="w-full md:w-5/6 border-l border-gray-400/50 bg-gray-500/10 p-6 md:ml-64 mt-14 md:mt-0">
        {children}
      </div>
